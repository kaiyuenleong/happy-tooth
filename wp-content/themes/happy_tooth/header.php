    ...
    <nav class="navbar navbar-expand-lg fixed-top py-0 px-0">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link" href="#">Buy One Give One</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="#">About Us</a>
          </li>
          <li class="nav-item">
            <a class="nav-link light" href="#">Our Programs</a>
          </li>
          <li class="nav-item">
            <a class="nav-link light nav-link-less-margin" href="#">Vendor Partners</a>
          </li>
          <li class="nav-item">
          ...
          <li class="nav-item">
            <a class="nav-link grant-link" href="#">Apply for a Grant</a>
          </li>
        </ul>
      </div>
    </nav>
